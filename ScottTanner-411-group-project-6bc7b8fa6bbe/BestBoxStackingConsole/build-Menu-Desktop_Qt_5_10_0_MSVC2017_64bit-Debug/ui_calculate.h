...
"}"));
        ...
        label_6->setGeometry(QRect(210, 60, 71, 20));
        label_6->setFont(font1);
        label_7 = new QLabel(Calculate);
        label_7->setObjectName(QStringLiteral("label_7"));
        label_7->setGeometry(QRect(220, 110, 47, 13));
        label_7->setFont(font2);
        label_8 = new QLabel(Calculate);
        label_8->setObjectName(QStringLiteral("label_8"));
        label_8->setGeometry(QRect(220, 140, 47, 13));
        label_8->setFont(font2);
        label_9 = new QLabel(Calculate);
        label_9->setObjectName(QStringLiteral("label_9"));
        label_9->setGeometry(QRect(220, 170, 47, 13));
