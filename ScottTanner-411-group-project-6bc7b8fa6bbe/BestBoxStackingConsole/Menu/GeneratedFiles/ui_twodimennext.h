...
"}"));
        ...
        lineEdit->setGeometry(QRect(70, 120, 131, 20));
        lineEdit_2 = new QLineEdit(TwoDimenNext);
        lineEdit_2->setObjectName(QStringLiteral("lineEdit_2"));
        lineEdit_2->setGeometry(QRect(70, 150, 131, 20));
        lineEdit_3 = new QLineEdit(TwoDimenNext);
        lineEdit_3->setObjectName(QStringLiteral("lineEdit_3"));
        lineEdit_3->setGeometry(QRect(70, 180, 131, 20));
        label_2 = new QLabel(TwoDimenNext);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(20, 120, 47, 13));
