...
"}"));
        ...
        lineEdit->setGeometry(QRect(20, 40, 131, 20));
...
"}"));
        ...
        pushButton_2->setGeometry(QRect(170, 70, 75, 23));
    ...
    void retranslateUi(QDialog *Save)
    {
        ...
        label->setText(QApplication::translate("Save", "Save as:", nullptr));
        pushButton->setText(QApplication::translate("Save", "Save", nullptr));
        pushButton_2->setText(QApplication::translate("Save", "Cancel", nullptr));
    } // retranslateUi
